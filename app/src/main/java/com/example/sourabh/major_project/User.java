...
*/
  ...
  /*      LocationManager lm = (LocationManager) getSystemService(LOCATION_SERVICE);
        ...
        ((SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.mapV)).getMapAsync(new OnMapReadyCallback() {
...
*/
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(this)
                .addConnectionCallbacks(User.this)
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        location = lm.getLastKnownLocation(LocationManager.GPS_PROVIDER);
        if (location == null) {
            Toast.makeText(User.this,"location null",Toast.LENGTH_LONG).show();
        }else {
    ...
    /*void setUpMap() {
        ...
        if (location == null) {
            ...
            Toast.makeText(User.this, "Setupt map method", Toast.LENGTH_LONG).show();
        ...
        mFusedLocationClient.getLastLocation()
                .addOnSuccessListener(this, new OnSuccessListener<Location>() {
                    ...
                    public void onSuccess(Location location) {
                        ...
                        if (location != null) {
                           Toast.makeText(User.this,"on connected",Toast.LENGTH_LONG).show();
                            handleNewLocation(location);
